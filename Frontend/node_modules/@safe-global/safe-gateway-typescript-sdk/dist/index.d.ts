...
import type { SafeTransactionEstimation, TransactionDetails, TransactionListPage, SafeIncomingTransfersResponse, SafeModuleTransactionsResponse, SafeMultisigTransactionsResponse, NoncesResponse, TransactionPreview } from '@safe-global/safe-gateway-typescript-sdk/dist/types/transactions';
import type { EthereumAddress, AllOwnedSafes, FiatCurrencies, OwnedSafes, SafeBalanceResponse, SafeCollectibleResponse, SafeCollectiblesPage } from '@safe-global/safe-gateway-typescript-sdk/dist/types/common';
import type { SafeInfo, SafeOverview } from '@safe-global/safe-gateway-typescript-sdk/dist/types/safe-info';
import type { ChainListResponse, ChainInfo } from '@safe-global/safe-gateway-typescript-sdk/dist/types/chains';
import type { SafeAppsResponse } from '@safe-global/safe-gateway-typescript-sdk/dist/types/safe-apps';
import type { MasterCopyReponse } from '@safe-global/safe-gateway-typescript-sdk/dist/types/master-copies';
import type { AnyConfirmationView, DecodedDataResponse } from '@safe-global/safe-gateway-typescript-sdk/dist/types/decoded-data';
import type { SafeMessage, SafeMessageListPage } from '@safe-global/safe-gateway-typescript-sdk/dist/types/safe-messages';
import type { DelegateResponse, DelegatesRequest } from '@safe-global/safe-gateway-typescript-sdk/dist/types/delegates';
import type { GetEmailResponse } from '@safe-global/safe-gateway-typescript-sdk/dist/types/emails';
import type { RelayCountResponse, RelayTransactionResponse } from '@safe-global/safe-gateway-typescript-sdk/dist/types/relay';
import type { Contract } from '@safe-global/safe-gateway-typescript-sdk/dist/types/contracts';
import type { AuthNonce } from '@safe-global/safe-gateway-typescript-sdk/dist/types/auth';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/safe-info';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/safe-apps';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/transactions';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/chains';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/common';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/master-copies';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/decoded-data';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/safe-messages';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/notifications';
export * from '@safe-global/safe-gateway-typescript-sdk/dist/types/relay';
/**
...
export declare function createAccount(body: operations['create_account']['parameters']['body']): Promise<import("@safe-global/safe-gateway-typescript-sdk/dist/types/accounts").Account>;
export declare function getAccount(address: string): Promise<import("@safe-global/safe-gateway-typescript-sdk/dist/types/accounts").Account>;
export declare function deleteAccount(address: string): Promise<void>;
export declare function getAccountDataTypes(): Promise<import("@safe-global/safe-gateway-typescript-sdk/dist/types/accounts").AccountDataType[]>;
export declare function getAccountDataSettings(address: string): Promise<import("@safe-global/safe-gateway-typescript-sdk/dist/types/accounts").AccountDataSetting[]>;
export declare function putAccountDataSettings(address: string, body: operations['put_account_data_settings']['parameters']['body']): Promise<import("@safe-global/safe-gateway-typescript-sdk/dist/types/accounts").AccountDataSetting[]>;
export declare function getIndexingStatus(chainId: string): Promise<import("@safe-global/safe-gateway-typescript-sdk/dist/types/chains").ChainIndexingStatus>;
