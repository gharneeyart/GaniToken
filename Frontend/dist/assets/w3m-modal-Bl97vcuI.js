import{M as k,a8 as le,R as c,C as pe,c as v,r as V,a as f,i as g,b as d,n as l,z as $,A as H,D as u,e as me,k as w,v as B,y as U,a4 as fe,V as F,E as K,O as A,s as M,g as we,S as E,K as z,a1 as oe,T as be,U as ce,a9 as ge,aa as ye}from"./index-B8dHvzVy.js";import{P as D}from"./index-DQOnv35W.js";import{S as ve}from"./SwapController-DF6n_iIw.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
